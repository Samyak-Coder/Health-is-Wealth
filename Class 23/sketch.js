...
function preload(){
    ...
    gameOverImage = loadImage("images/game-over.gif");
...
function setup(){
    ...
    fatBoy = createSprite(500,500,50,50);
...
function draw(){
    ...
    stroke("black");
    strokeWeight(2);
    text("IMMUNITY " + imunity, 1000,100);
...
function gameOverF(){
   ...
   var gameOver = createSprite(500,300,2000,700);
...
function gameOverW(){
    ...
    var gameOverW = createSprite(500,300,2000,700);
